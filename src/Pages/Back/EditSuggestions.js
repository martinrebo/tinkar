...
import { Button, Form, Modal, Checkbox, TextArea, Container, Input } from 'semantic-ui-react'
import { fire, firebaseApp } from '../../fire';
import { useStateValue } from '../../State/State';

export default function EditSuggestions(props) {
    ...
    const [media, setMedia] = useState(""); // Audio, Video, Text, Code, Live, Misc
    const [mediaType, setMediaType] = useState(""); // Blog, Podcast, Book, etcc
    const [position, setPosition] = useState(""); // Frontend, Backend, Devops, Full
    const [eco, setEco] = useState(""); // React, Angular, Node, 
    ...
    return (
        <Modal trigger={<Button>Edit Suggestion</Button>} closeIcon >
            <Modal.Content>
                ...
                <Container>
                    <Form onSubmit={(e) => { sendData(e) }}>
                        ...
                        <Button type="submit" className="submit"> Submit Suggested Card </Button>
                    </Form>
                </Container>
            </Modal.Content>
        </Modal>
